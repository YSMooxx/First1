...
class NetManager:NSObject {
    ...
    func request(netModel:NetBaseModel,success:@escaping (_ json:Any)->Void,failure:@escaping (_ error:Any)->Void) {
        ...
        AF.session.configuration.timeoutIntervalForResource = 15
        
        AF.session.configuration.timeoutIntervalForRequest = 15
        
        AF.request(URL(string: netModel.url)!, method: method, parameters:parameter,requestModifier: { $0.timeoutInterval = 15}).responseData { (response) in
    ...
    func requestToken(netModel:NetBaseModel,success:@escaping (_ json:Any)->Void,failure:@escaping (_ error:Any)->Void) {
        ...
        AF.request(URL(string: netModel.url)!, method: method, parameters:parameter,headers: headers,requestModifier: { $0.timeoutInterval = 15}).responseData { (response) in
