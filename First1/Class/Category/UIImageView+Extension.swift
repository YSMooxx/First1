...
@objc extension UIImageView {
    ...
    func setImageWithUrlRefresh(urlString:String,placeholderImage:String,result: @escaping ( _ image2:UIImage, _ error1:NSError)->Void){
    ...
    func setImageWithUrl(urlString:String,placeholderImage:String,result: @escaping ( _ image2:UIImage, _ error1:NSError)->Void){
        ...
        if urlString.isUrlString() {
            ...
            self.sd_setImage(with: URl as URL, placeholderImage: UIImage.init(named: placeholderImage)) { image1, error, cacheType, url in
